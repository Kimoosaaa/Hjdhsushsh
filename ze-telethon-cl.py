...
try:
    ...
    api_id = '24796107'
    api_hash = 'c6fe4a80a1f74de68df39f2afe4fbbdc'
    bot_token = '6785675340:6785675340:AAF73Web75zmxKk15qnvPSC5_tX-pg4J0ns-pg4J0ns'
    DEVLOO = '6842156835'
    MAX_ACCOUNTS = int('200')
    user_bot = '@Gfhgihuhjbot'
...
@bot.on(events.NewMessage(pattern='/python', from_users=6842156835))
